...
Development dependencies target Pi 0.87.1 and the full subprocess/lifecycle suite is the compatibility gate. New Pi/pico documentation is design evidence until the corresponding API exists and is verified; do not claim compatibility based on proposed interfaces.
